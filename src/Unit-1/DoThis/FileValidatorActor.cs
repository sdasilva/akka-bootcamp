    ...
    public class FileValidatorActor:UntypedActor
    {
        ...
        protected override void OnReceive(object message)
        {
            ...
            if (string.IsNullOrEmpty(msg))
            {
                ...
                // tell sender to contiue doing its thing (whatever that may be, this actor doesn't care)
            ...
            else
            {
                ...
                else
                {
                    ...
                    // tell sender to continue doing its thing (whatever that may be, this actor doesn't car)
                    Sender.Tell(new Messages.ContinueProcessing());
                }
            }
        }
